        ...
        <div class="row ">
          <div class="col-4" style="padding: 0px 40px">
            <div style="padding: 0px 80px">
              <h1 class="page-title" style="margin-top:120px">Molly Ahlgren's Aquarium</h1>
              <div class="text-col"><p>The small aquarium in the Sage building was christened the Molly O. Ahlgren Aquarium, after the late Sheldon Jackson College environmental studies professor. Molly started the aquarium to share the intertidal with visitors and Sitka residents.</p>
              </div>
            </div>
          </div>
          <div class="col-8 px-0" style="">
            <img class="img-full obj-fit-cover h-100 obj-pos-t" src="/images/history/Molly_Ahlgren_touch.jpg" />
...
export default {
  ...
  //JXSlider.updateSlider(percentage, animate);
	...
	transition: {
      ...
      var text= document.getElementsByClassName("text-col")[0];
