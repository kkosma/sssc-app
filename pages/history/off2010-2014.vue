        ...
        <div class="row ">
          <div class="col-4" style="padding: 0px 40px">
            <div style="padding: 0px 80px">
              <h1 class="page-title" style="margin-top:120px">Renovation</h1>
              <div class="text-col"><p>In 2010, the Science Center purchased the Mill and Sage buildings taking over the hatchery and the aquarium. The purchase was made possible by an economic development grant from the City of Sitka, a grant from the Karsh Family Foundation and a loan from local commercial fishermen. The Science Center completed a $1.3 million exterior renovation in 2014 with funding from the Rasmuson Foundation, the M.J. Murdock Trust and the Ahlgren Family Fund.</p>
              </div>
            </div>
          </div>
          <div class="col-8 px-0" style="">
            <img class="img-full obj-fit-cover h-100" src="/images/history/construction.jpg" />
...
export default {
  ...
  //JXSlider.updateSlider(percentage, animate);
	...
	transition: {
      ...
      var text= document.getElementsByClassName("text-col-2")[0];
