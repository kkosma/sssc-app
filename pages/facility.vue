	...
	<div class="page1" style="background-color:black">
		...
		<div class="top-nav " >
				...
				<ul>
					...
					<li ><nuxt-link to="/facility"  >{{currentRoute[0].toUpperCase() + currentRoute.substr(1)}}</nuxt-link></li>
				</ul>
		</div>
		...
		<svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" id="svgBack">
			<linearGradient id="background" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="100%">
				<stop id="start" offset="0%" stop-color="rgb(115, 166, 195)"/>
				<stop id="end" offset="100%" stop-color="rgb(11, 53, 78)"/>
			</linearGradient>
		...
		<div class="animals-back-img">
			<img src="/images/facility/Hatchery.jpg" class="img-fluid obj-fit-cover obj-pos-c" >
		</div>
...
let yearPages=[
	'1910','1929','1972','2001','2005','2007','2010','156a9b'
]
let currentRoute
let context1
let transitionName
...
export default {
	...
	head() {
     return{
    style: [
      { cssText: '.animal-name-back { background-color: '+ this.shadeColor('#156a9b',.4) +'!important;color:'+this.shadeColor('#156a9b',.4) + '!important } .overlay-w{background:'+this.shadeColor('#156a9b',.2)+'!important} .back-button{background:'+this.shadeColor('#156a9b',-.5)+'!important}.nav-right{background:'+this.shadeColor('#156a9b',.1)+'!important}.top-nav{background:'+this.shadeColor('#156a9b',-.3)+'!important}.hero-image-con img,.animal-tile img{background:'+this.shadeColor('#156a9b',.3)+'!important}', type: 'text/css' }
    ]
     }
