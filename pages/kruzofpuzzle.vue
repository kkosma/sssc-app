    ...
    <div class="tutorial-popup " id="popper">
      ...
      <div class="tutorial-popup-inner">
        <div class="tutorial-content">
          ...
          <p >Congratulations! <br> You've assembled the bones and Kruzof swims again.</p>
        </div>
...
export default {
  ...
  //plugins: [{ src: "../js/kruzof.js", ssr: false, body:true }],
  head() {
    return {
      title: this.name,
      script: [
        { src: "../js/kruzof.js", ssr: false, body:true }
      ]
    };
  },
  mounted() {
  ...
  transition: {
      ...
      beforeLeave: function(el){
        ...
        //console.log(app.timers,'BeforTimers')
        //console.log(app.callbackOnLoad,'LOADCALL')
       // console.log(app.callbackOnLoad,'LOADCALL')
      ...
      console.log(app.boneMatBump,"before Bone")
      app.boneMatBump.dispose()
       console.log(app.boneMatBump,"after Bone")
      disposeNode(app.scene)
      ...
      console.log(app.scene,"SCENE DISPOSED")
     // app.scene.dispose()
      console.log(app.renderer.info,"RENDER INFO",app.scene)
      app.renderer.renderLists.dispose();
      app.renderer.dispose()
      app.renderer.forceContextLoss(); 
      app.renderer.context=undefined;
      app.renderer.domElement=undefined;
      app.renderer=null
       
       cancelAnimationFrame(app.renderRequest);
        for (var timer in app.timers) {
        //  console.log(timer,'LOOPTIMER')
          clearTimeout(app.timers[timer])
          //delete app.timers[timer]
        }
       app.timers={}
     
      // app={}
       // console.log(app.timers,'HOMETIMERS')
