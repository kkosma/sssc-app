	...
	<div class="page1" style="background-color:black;">
		...
		<div class="top-nav " >
				...
				<ul>
					...
					<li ><nuxt-link to="/education"  >{{currentRoute[0].toUpperCase() + currentRoute.substr(1)}}</nuxt-link></li>
				</ul>
		</div>
		...
		<div class="animals-back-img">
			<img src="/images/education/education.jpg" class="img-fluid obj-fit-cover obj-pos-c" >
		</div>
...
export default {
	...
	head() {
     return{
    style: [
      { cssText: '.animal-name-back { background-color: '+ this.shadeColor('#3356a0',.4) +'!important;color:'+this.shadeColor('#3356a0',.4) + '!important } .overlay-w{background:'+this.shadeColor('#3356a0',.2)+'!important} .back-button{background:'+this.shadeColor('#3356a0',-.5)+'!important}.nav-right{background:'+this.shadeColor('#3356a0',.1)+'!important}.top-nav{background:'+this.shadeColor('#3356a0',-.3)+'!important}.hero-image-con img,.animal-tile img{background:'+this.shadeColor('#3356a0',.3)+'!important}', type: 'text/css' }
    ]
     }
