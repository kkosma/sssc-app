(function (global, factory) {
  ...
  var Impetus = function Impetus(_ref) {
    ...
    // Added Route reference
    var route= _ref.route;console.log('myroute',route)
    ...
    (function init() {
      ...
      sourceEl.firstChild.classList.add('force-gpu')
      if (!sourceEl) {
    ...
    function onMove(ev) {
      ...
      Math.abs(event.x - pointerInitialX) > 10 && eventDisabled == false ? removeRouteClick() : null
      //console.log('break', route.disabled, eventDisabled, trackingPoints, pointerInitialX, Math.abs(trackingPoints[0].x - pointerInitialX))
     ...
     * Stops route next
     */
    function removeRouteClick() {
      route.disabled = true; eventDisabled = true
    }
    /**
    ...
    function addTrackingPoint(x, y) {
      ...
      while (trackingPoints.length > 0) {
        //console.log('break', trackingPoints, pointerInitialX, Math.abs(trackingPoints[0].x - pointerInitialX))
       
        if (time - trackingPoints[0].time <= 100) {
          //console.log('break', trackingPoints)
          break;
        }
